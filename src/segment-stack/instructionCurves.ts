 ...
 *
 * The timeline used to draw every gesture as the same rounded bar: true about when a
 * gesture happens, silent about what it is. A `<dynamics>` that swells and one that fades
 * came out identical. These samplers are the other half — the shape itself, read at enough
 * places across the card to draw.
 *
