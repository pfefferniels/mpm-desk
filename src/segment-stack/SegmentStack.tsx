    ...
    return (
        <Card
            ...
            style={{
                overflow: "scroll",
                position: "relative",
                // Its container's, not the viewport's. In the viewer the tree WAS the page and
                // the two were the same thing; in the editor a desk takes the lower half, and a
                // tree still measuring itself against the window overflows it and leaves the
                // reading pinned to the top edge with dead space underneath.
                height: "100%",
                width: "100%",
                borderRadius: 0,
                outline: "none",
