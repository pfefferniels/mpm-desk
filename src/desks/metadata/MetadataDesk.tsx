 ...
 * The column.
 *
 * No gutter for the `AspectSelect` card that floats at the top right: the desks have the whole
 * width, and a reader the card is in the way of collapses it.
 *
 ...
 * border-box the 6rem of side padding would come out of it.
 */
const page = {
